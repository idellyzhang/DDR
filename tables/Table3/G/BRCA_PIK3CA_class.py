...
pattern = 'BRCA_PIK3CA_feature.csv'
data_r = pd.read_csv(pattern)

data = biomarker_selection(data_r,3)

MU = data['Group'] == "PIK3CA"
WT = data['Group'] == "WT"
...
print("PIK3CA mut: ", mean(MU_acc))
print("PIK3CA wt: ",mean(WT_acc))
