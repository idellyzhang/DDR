...
pattern = 'GSE37418_14_feature.csv'
...
test = 'GSE37382_validation_feature.csv'
...
SHH_pred = y_pred[0:51]
G3_pred = y_pred[51:97]
G4_pred = y_pred[97:285]
...
SHH_accuracy = len(SHH_pred[SHH_corr])/51
SHH_G3 = len(SHH_pred[SHH_G3])/51
SHH_G4 = len(SHH_pred[SHH_G4])/51

G3_accuracy = len(G3_pred[G3_corr])/46
G3_SHH = len(G3_pred[G3_SHH])/46
G3_G4 = len(G3_pred[G3_G4])/46


G4_accuracy = len(G4_pred[G4_corr])/188
G4_SHH = len(G4_pred[G4_SHH])/188
G4_G3 = len(G4_pred[G4_G3])/188
